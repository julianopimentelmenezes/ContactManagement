...
{
    /// <summary>
    /// This class call all the contact validations to the Update functionality
    /// </summary>
    public class ContactCanUpdateValidation
        : Validator<Contact>
    {
        public ContactCanUpdateValidation(IContactRepository contactRepository)
        {
